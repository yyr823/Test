...
/**
 * @author PE
 * @date 2019年7月1日 下午4:26:18
 * @explain 对表格进行增删改和分页操作
 */
public class HeroTable {
	 public static int currentPage;//当前页
	    public static int lastPage;//最后一页
	    ...
	    static JComboBox<Object> cb = new JComboBox<Object>();
